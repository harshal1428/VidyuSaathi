...
class _OfficerTeamScreenState extends State<OfficerTeamScreen> {
  ...
  // Simulating: Officers see all staff, Field Officers see no one or just helpers
  List<StaffMember> get teamMembers {
     // In a real app, we would check the current user's role.
     // For this mock, we return all staff as requested to "display list of subordinate staff".
     // We can add a filter later.
     return MockDataService.staffData;
  }
