...
class _JEDashboardSectionState extends State<JEDashboardSection> {
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildFieldOfficersSection(isDark),
          const SizedBox(height: 20),
  ...
  Widget _buildFieldOfficersSection(bool isDark) {
    // Example FE list, replace with actual data source
    final List<Map<String, dynamic>> fieldOfficers = [
      {
        'name': 'Amit Kumar',
        'officerId': 'FE-001',
        'activeTickets': 4,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          ...fieldOfficers.map((fe) => Column(
            children: [
              _buildFieldOfficerItem(
                name: fe['name'],
                officerId: fe['officerId'],
                activeTickets: fe['activeTickets'],
                status: fe['status'],
                isDark: isDark,
              ),
              const SizedBox(height: 8),
