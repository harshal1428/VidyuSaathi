...
class _DyEEDashboardSectionState extends State<DyEEDashboardSection> {
  ...
  Widget _buildSubdivisionOfficersOverview() {
    ...
    final List<Map<String, String>> fes = [
      {'name': 'Nilesh Pawar', 'designation': 'Field Officer', 'zone': 'Zone A', 'status': 'Active'},
      {'name': 'Suresh Kapse', 'designation': 'Field Officer', 'zone': 'Zone A', 'status': 'Active'},
      {'name': 'Deepak Shinde', 'designation': 'Field Officer', 'zone': 'Zone A', 'status': 'On Leave'},
      // Add more FEs as needed
    ];
